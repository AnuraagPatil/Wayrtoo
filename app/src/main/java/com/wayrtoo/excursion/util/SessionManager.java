...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public String getCityId(){return pref.getString(CITY_ID,"6");}

    public String getCityName(){return pref.getString(CITY_NAME,"Dubai");}

    public String getCityImage(){return pref.getString(CITY_IMAGE,"https://guiddooimages.blob.core.windows.net/booking-engine-images/dubai.jpg");}

    public String getBaseUrl(){return pref.getString(BASE_URL,null);}

    public String getCountryName(){return pref.getString(COUNTRY_NAME,null);}

    public String getSelectFragmentPosition(){return pref.getString(SELECT_FRAGMENT,"0");}

    public String getCityStatus(){return pref.getString(CITY_STATUS,"false");}

    public String getCityList(){return pref.getString(CITY_LIST,"");}

    public String getActivityStatus(){return pref.getString(ACTIVITY_STATUS,"false");}

    public String getSortingPosition(){return pref.getString(SORTING_ID,"");}

    public String getFilterMin(){return pref.getString(FILTER_MIN,"0");}

    public String getFilterMax(){return pref.getString(FILTER_MAX,"5000");}


    /*  City get All List */

    public String getCityAbuDhabi(){return pref.getString(ACTIVITY_ABU_DHABI,"");}
    public String getCityDubai(){return pref.getString(ACTIVITY_DUBAI,"");}
    public String getCityBali(){return pref.getString(ACTIVITY_BALI,"");}
    public String getCitySingapore(){return pref.getString(ACTIVITY_SINGAPORE,"");}
    public String getCityBangkok(){return pref.getString(ACTIVITY_BANGKOK,"");}
    public String getCityHongKong(){return pref.getString(ACTIVITY_HONG_KONG,"");}
    public String getCityKaulaLumpur(){return pref.getString(ACTIVITY_KUALA_LUMPUR,"");}
    public String getCityLangkawi(){return pref.getString(ACTIVITY_LANGKAWI,"");}
    public String getCityPenang(){return pref.getString(ACTIVITY_PENANG,"");}
